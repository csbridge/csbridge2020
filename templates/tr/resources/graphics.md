...
## Adding Images
_Note: if images do not work in your program, and instead give an error, you may not have installed the library necessary for images to work.  Make sure you followed the instructions in the [installation guide]({{pathToRoot}}tr/resources/install.html) under "Installing Graphics"._
{: .alert .alert-info}
